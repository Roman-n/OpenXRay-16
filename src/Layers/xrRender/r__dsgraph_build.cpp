...
////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////
///  LA->Anomaly optimization  ///
// Static geometry optimization
#define O_S_L1_S_LOW  20.f  // geometry 3d volume size                  // геометрия 3d объемный размер
#define O_S_L1_D_LOW  150.f // distance, after which it is not rendered // расстояние, после которого оно не визуализируется
#define O_S_L2_S_LOW  75.f
#define O_S_L2_D_LOW  200.f
#define O_S_L3_S_LOW  350.f
#define O_S_L3_D_LOW  250.f
#define O_S_L4_S_LOW  1500.f
#define O_S_L4_D_LOW  300.f
#define O_S_L5_S_LOW  5000.f
#define O_S_L5_D_LOW  350.f
#define O_S_L6_S_LOW  20000.f
#define O_S_L6_D_LOW  400.f
#define O_S_L7_S_LOW  40000.f
#define O_S_L7_D_LOW  500.f
#define O_S_L8_S_LOW  75000.f
#define O_S_L8_D_LOW  600.f
#define O_S_L9_S_LOW  150000.f
#define O_S_L9_D_LOW  750.f
#define O_S_L10_S_LOW 250000.f
#define O_S_L10_D_LOW 900.f
#define O_S_L11_S_LOW 350000.f
#define O_S_L11_D_LOW 1100.f
#define O_S_L12_S_LOW 500000.f
#define O_S_L12_D_LOW 1400.f
#define O_S_L13_S_LOW 750000.f
#define O_S_L13_D_LOW 1750.f
#define O_S_L14_S_LOW 1000000.f
#define O_S_L14_D_LOW 2000.f
#define O_S_L15_S_LOW 1500000.f
#define O_S_L15_D_LOW 2500.f

#define O_S_L1_S_MED  30.f
#define O_S_L1_D_MED  100.f
#define O_S_L2_S_MED  200.f
#define O_S_L2_D_MED  150.f
#define O_S_L3_S_MED  1000.f
#define O_S_L3_D_MED  175.f
#define O_S_L4_S_MED  3500.f
#define O_S_L4_D_MED  225.f
#define O_S_L5_S_MED  10000.f
#define O_S_L5_D_MED  275.f
#define O_S_L6_S_MED  25000.f
#define O_S_L6_D_MED  350.f
#define O_S_L7_S_MED  50000.f
#define O_S_L7_D_MED  400.f
#define O_S_L8_S_MED  100000.f
#define O_S_L8_D_MED  500.f
#define O_S_L9_S_MED  200000.f
#define O_S_L9_D_MED  700.f
#define O_S_L10_S_MED 350000.f
#define O_S_L10_D_MED 850.f
#define O_S_L11_S_MED 500000.f
#define O_S_L11_D_MED 1000.f
#define O_S_L12_S_MED 750000.f
#define O_S_L12_D_MED 1200.f
#define O_S_L13_S_MED 1000000.f
#define O_S_L13_D_MED 1500.f
#define O_S_L14_S_MED 1500000.f
#define O_S_L14_D_MED 1750.f
#define O_S_L15_S_MED 2000000.f
#define O_S_L15_D_MED 2000.f

#define O_S_L1_S_HII  50.f
#define O_S_L1_D_HII  75.f
#define O_S_L2_S_HII  250.f
#define O_S_L2_D_HII  120.f
#define O_S_L3_S_HII  1500.f
#define O_S_L3_D_HII  160.f
#define O_S_L4_S_HII  5000.f
#define O_S_L4_D_HII  200.f
#define O_S_L5_S_HII  20000.f
#define O_S_L5_D_HII  250.f
#define O_S_L6_S_HII  35000.f
#define O_S_L6_D_HII  300.f
#define O_S_L7_S_HII  55000.f
#define O_S_L7_D_HII  350.f
#define O_S_L8_S_HII  150000.f
#define O_S_L8_D_HII  425.f
#define O_S_L9_S_HII  250000.f
#define O_S_L9_D_HII  550.f
#define O_S_L10_S_HII 400000.f
#define O_S_L10_D_HII 700.f
#define O_S_L11_S_HII 750000.f
#define O_S_L11_D_HII 850.f
#define O_S_L12_S_HII 1000000.f
#define O_S_L12_D_HII 1000.f
#define O_S_L13_S_HII 1500000.f
#define O_S_L13_D_HII 1200.f
#define O_S_L14_S_HII 2000000.f
#define O_S_L14_D_HII 1500.f
#define O_S_L15_S_HII 2500000.f
#define O_S_L15_D_HII 1700.f

#define O_S_L1_S_ULT  75.f
#define O_S_L1_D_ULT  50.f
#define O_S_L2_S_ULT  300.f
#define O_S_L2_D_ULT  100.f
#define O_S_L3_S_ULT  1750.f
#define O_S_L3_D_ULT  140.f
#define O_S_L4_S_ULT  6000.f
#define O_S_L4_D_ULT  175.f
#define O_S_L5_S_ULT  25000.f
#define O_S_L5_D_ULT  225.f
#define O_S_L6_S_ULT  40000.f
#define O_S_L6_D_ULT  270.f
#define O_S_L7_S_ULT  75000.f
#define O_S_L7_D_ULT  320.f
#define O_S_L8_S_ULT  200000.f
#define O_S_L8_D_ULT  400.f
#define O_S_L9_S_ULT  300000.f
#define O_S_L9_D_ULT  500.f
#define O_S_L10_S_ULT 500000.f
#define O_S_L10_D_ULT 650.f
#define O_S_L11_S_ULT 850000.f
#define O_S_L11_D_ULT 750.f
#define O_S_L12_S_ULT 1250000.f
#define O_S_L12_D_ULT 850.f
#define O_S_L13_S_ULT 1500000.f
#define O_S_L13_D_ULT 950.f
#define O_S_L14_S_ULT 2500000.f
#define O_S_L14_D_ULT 1200.f
#define O_S_L15_S_ULT 5000000.f
#define O_S_L15_D_ULT 1500.f

// Dyn geometry optimization

#define O_D_L1_S_LOW 1.f   // geometry 3d volume size
#define O_D_L1_D_LOW 100.f // distance, after which it is not rendered
#define O_D_L2_S_LOW 5.f
#define O_D_L2_D_LOW 150.f
#define O_D_L3_S_LOW 2500.f
#define O_D_L3_D_LOW 250.f
#define O_D_L4_S_LOW 7500.f
#define O_D_L4_D_LOW 500.f
#define O_D_L5_S_LOW 25000.f
#define O_D_L5_D_LOW 750.f
#define O_D_L6_S_LOW 75000.f
#define O_D_L6_D_LOW 1000.f

#define O_D_L1_S_MED 5.f
#define O_D_L1_D_MED 75.f
#define O_D_L2_S_MED 15.f
#define O_D_L2_D_MED 100.f
#define O_D_L3_S_MED 3000.f
#define O_D_L3_D_MED 200.f
#define O_D_L4_S_MED 10000.f
#define O_D_L4_D_MED 400.f
#define O_D_L5_S_MED 30000.f
#define O_D_L5_D_MED 600.f
#define O_D_L6_S_MED 100000.f
#define O_D_L6_D_MED 800.f

#define O_D_L1_S_HII 5.0f
#define O_D_L1_D_HII 60.f
#define O_D_L2_S_HII 20.f
#define O_D_L2_D_HII 80.f
#define O_D_L3_S_HII 4000.f
#define O_D_L3_D_HII 100.f
#define O_D_L4_S_HII 12000.f
#define O_D_L4_D_HII 300.f
#define O_D_L5_S_HII 40000.f
#define O_D_L5_D_HII 500.f
#define O_D_L6_S_HII 125000.f
#define O_D_L6_D_HII 750.f

#define O_D_L1_S_ULT 5.0f
#define O_D_L1_D_ULT 50.f
#define O_D_L2_S_ULT 25.f
#define O_D_L2_D_ULT 75.f
#define O_D_L3_S_ULT 5000.f
#define O_D_L3_D_ULT 100.f
#define O_D_L4_S_ULT 15000.f
#define O_D_L4_D_ULT 250.f
#define O_D_L5_S_ULT 50000.f
#define O_D_L5_D_ULT 400.f
#define O_D_L6_S_ULT 200000.f
#define O_D_L6_D_ULT 500.f
...
Fvector4 o_optimize_static_l13_dist = { O_S_L13_D_LOW, O_S_L13_D_MED, O_S_L13_D_HII, O_S_L13_D_ULT };
Fvector4 o_optimize_static_l13_size = { O_S_L13_S_LOW, O_S_L13_S_MED, O_S_L13_S_HII, O_S_L13_S_ULT };
Fvector4 o_optimize_static_l14_dist = { O_S_L14_D_LOW, O_S_L14_D_MED, O_S_L14_D_HII, O_S_L14_D_ULT };
Fvector4 o_optimize_static_l14_size = { O_S_L14_S_LOW, O_S_L14_S_MED, O_S_L14_S_HII, O_S_L14_S_ULT };
Fvector4 o_optimize_static_l15_dist = { O_S_L15_D_LOW, O_S_L15_D_MED, O_S_L15_D_HII, O_S_L15_D_ULT };
Fvector4 o_optimize_static_l15_size = { O_S_L15_S_LOW, O_S_L15_S_MED, O_S_L15_S_HII, O_S_L15_S_ULT };
...
Fvector4 o_optimize_dynamic_l6_dist = { O_D_L6_D_LOW, O_D_L6_D_MED, O_D_L6_D_HII, O_D_L6_D_ULT };
Fvector4 o_optimize_dynamic_l6_size = { O_D_L6_S_LOW, O_D_L6_S_MED, O_D_L6_S_HII, O_D_L6_S_ULT };
    ...
    if ((isStatic && opt_static >= 1) || (!isStatic && opt_dynamic >= 1))
    {
        ...
        if (sm && !!psDeviceFlags.test(rsOptShadowGeom)) // Highest cut off for shadow map
        {
            ...
            if ((sphere_volume < o_optimize_static_l1_size.z) && (adjusted_distane > o_optimize_static_l1_dist.z))
                ...
                return false;
            else if ((sphere_volume < o_optimize_static_l13_size.z) && (adjusted_distane > o_optimize_static_l13_dist.z))
                return false;
            else if ((sphere_volume < o_optimize_static_l14_size.z) && (adjusted_distane > o_optimize_static_l14_dist.z))
                return false;
            else if ((sphere_volume < o_optimize_static_l15_size.z) && (adjusted_distane > o_optimize_static_l15_dist.z))
                return false;
        }
        ...
        if (isStatic)
        {
            if (opt_static == 2)
            {
                if ((sphere_volume < o_optimize_static_l1_size.y) && (adjusted_distane > o_optimize_static_l1_dist.y))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_static_l13_size.y) && (adjusted_distane > o_optimize_static_l13_dist.y))
                    return false;
                else if ((sphere_volume < o_optimize_static_l14_size.y) && (adjusted_distane > o_optimize_static_l14_dist.y))
                    return false;
                else if ((sphere_volume < o_optimize_static_l15_size.y) && (adjusted_distane > o_optimize_static_l15_dist.y))
                    return false;
            }
            ...
            else if (opt_static == 4)
            {
                if ((sphere_volume < o_optimize_static_l1_size.w) && (adjusted_distane > o_optimize_static_l1_dist.w))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_static_l13_size.w) && (adjusted_distane > o_optimize_static_l13_dist.w))
                    return false;
                else if ((sphere_volume < o_optimize_static_l14_size.w) && (adjusted_distane > o_optimize_static_l14_dist.w))
                    return false;
                else if ((sphere_volume < o_optimize_static_l15_size.w) && (adjusted_distane > o_optimize_static_l15_dist.w))
                    return false;
            }
            else
            {
                if ((sphere_volume < o_optimize_static_l1_size.x) && (adjusted_distane > o_optimize_static_l1_dist.x))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_static_l13_size.x) && (adjusted_distane > o_optimize_static_l13_dist.x))
                    return false;
                else if ((sphere_volume < o_optimize_static_l14_size.x) && (adjusted_distane > o_optimize_static_l14_dist.x))
                    return false;
                else if ((sphere_volume < o_optimize_static_l15_size.x) && (adjusted_distane > o_optimize_static_l15_dist.x))
                    return false;
            }
        }
        else
        {
            if (opt_dynamic == 2)
            {
                if ((sphere_volume < o_optimize_dynamic_l1_size.y) && (adjusted_distane > o_optimize_dynamic_l1_dist.y))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_dynamic_l6_size.y) && (adjusted_distane > o_optimize_dynamic_l6_dist.y))
                    return false;
            }
            else if (opt_dynamic == 3)
            {
                if ((sphere_volume < o_optimize_dynamic_l1_size.z) && (adjusted_distane > o_optimize_dynamic_l1_dist.z))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_dynamic_l6_size.z) && (adjusted_distane > o_optimize_dynamic_l6_dist.z))
                    return false;
            }
            else if (opt_dynamic == 4)
            {
                if ((sphere_volume < o_optimize_dynamic_l1_size.w) && (adjusted_distane > o_optimize_dynamic_l1_dist.w))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_dynamic_l6_size.w) && (adjusted_distane > o_optimize_dynamic_l6_dist.w))
                    return false;
            }
            else
            {
                if ((sphere_volume < o_optimize_dynamic_l1_size.x) && (adjusted_distane > o_optimize_dynamic_l1_dist.x))
                    ...
                    return false;
                else if ((sphere_volume < o_optimize_dynamic_l6_size.x) && (adjusted_distane > o_optimize_dynamic_l6_dist.x))
                    return false;
            }
        }
    }
